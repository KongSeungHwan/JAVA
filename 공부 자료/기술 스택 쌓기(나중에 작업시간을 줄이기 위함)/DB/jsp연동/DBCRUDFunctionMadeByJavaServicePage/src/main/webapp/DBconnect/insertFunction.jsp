...
<body>
	...
	try{
		...
		pstmt = conn.prepareStatement("insert into client set client_name=?, client_id=?,client_password=?,balance=?,account_number=?,bank = ?;");
	...
	<% 		accountNumber++;}catch(SQLException se){
		se.printStackTrace();
	}finally{
		if(rs != null) rs.close();
