...
public class Menu {
	...
	void loginMenu() throws NumberFormatException, IOException, InterruptedException {
		...
		System.out.println("★★1은 땅★★2는 폭탄 땅★★★★");
		...
		case 2:
			clear();
			clear();
			System.out.println("이 지뢰 찾기 게임은 선택한 좌표의 동서남북 방향으로");
			System.out.println("폭탄이 있다면 열리지 않고 폭탄이 없는 일반 땅이면 ");
			System.out.println("연쇄적으로 열리는 룰이다. 재량껏 찾아보길 바란다!");
